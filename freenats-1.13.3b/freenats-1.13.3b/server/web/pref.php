...
<table border=0>
<tr><td colspan=2><b><u><?php echo $NATS->Lang->Item("change.password"); ?></u></b></td></tr>
<form action=pref.php method=post>
<input type=hidden name=action value=password>
<tr><td align=right><?php echo $NATS->Lang->Item("current"); ?> :</td>
<td><input type=password name=p_current size=20 maxlength=60></td></tr>
<tr><td align=right><?php echo $NATS->Lang->Item("new"); ?> :</td>
<td><input type=password name=p_new size=20 maxlength=60></td></tr>
<tr><td align=right><?php echo $NATS->Lang->Item("confirm"); ?> :</td>
<td><input type=password name=p_confirm size=20 maxlength=60></td></tr>
<tr><td colspan=2><input type=submit value="<?php echo $NATS->Lang->Item("change.password"); ?>"></td></tr>
</form>
</table>
<br><br>
