...
?>
<tr><td align=right>
<b><?php echo $NATS->Lang->Item("username"); ?>: </b></td><td><input type=text name=naun size=20 maxlength=32 style="width: 160px;"></td></tr>
<tr><td align=right><b><?php echo $NATS->Lang->Item("password"); ?>: </b></td><td><input type=password name=napw size=21 style="width: 160px;" maxlenth=64></td></tr>
<tr><td align=right><b><?php echo $NATS->Lang->Item("language"); ?>: </b></td>
